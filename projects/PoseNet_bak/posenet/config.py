...
def add_posenet_config(cfg):
    ...
    _C.MODEL.POSENET_RPN.PRE_NMS_TOP_N_TRAIN = 10000
    _C.MODEL.POSENET_RPN.PRE_NMS_TOP_N_TEST = 5000
    _C.MODEL.POSENET_RPN.POST_NMS_TOP_N_TRAIN = 1000
    _C.MODEL.POSENET_RPN.POST_NMS_TOP_N_TEST = 100
